...
Multi-objective inverse design of a Blended Wing Body (BWB) aircraft against three
mission profiles, using NSGA-III over trained forward surrogates for aerodynamics
and structures. Built for the ASME IDETC/CIE Hackathon (nTop x MIT DeCoDE Lab).
